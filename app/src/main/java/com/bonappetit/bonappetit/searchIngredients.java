 ...
 */
public class searchIngredients extends androidx.fragment.app.Fragment implements FiltersDialog.OnFiltersChanged{
    ...
    private void updateFilters() {
        ...
        filtersDialog.setTargetFragment(searchIngredients.this,1);
    ...
    private void sendRequest() {
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET,
                apiURL + "/complexSearch?maxCalories=10000&number=100&includeIngredients="+searchTerm.getText().toString().trim().replace(" ",",") + apiID,
                null,
    ...
    private void sendRequestWithDiet() {
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET,
                apiURL + "/complexSearch?maxCalories=10000&number=100&includeIngredients="+searchTerm.getText().toString().trim().replace(" ",",") +"&diet="+diet+ apiID,
                null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    private void sendRequestWithIntolerances() {
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET,
                apiURL + "/complexSearch?maxCalories=10000&number=100&includeIngredients="+searchTerm.getText().toString().trim().replace(" ",",") +"&intolerances="+intolerances+ apiID,
                null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    private void sendRequestWithFilters() {
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET,
                apiURL + "/complexSearch?maxCalories=10000&number=100&includeIngredients="+searchTerm.getText().toString().trim().replace(" ",",") +"&diet="+diet+"&intolerances="+intolerances+ apiID,
                null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
